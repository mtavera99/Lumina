...
export function Intelligence() {
  ...
  return (
    <div className="intelligence">
      ...
      <div className="intelligence-privacy"><span>🛡️</span><p><b>Privacidad:</b> Gmail se filtra para reportes de read.ai. Los secretos de Supabase y Gemini viven solamente en Netlify; el navegador nunca los recibe.</p></div>
    </div>
  )
}
